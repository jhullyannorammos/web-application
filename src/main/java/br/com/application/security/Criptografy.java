...
public class Criptografy {
    ...
    public static String convertStringToMD5(String valor) {
        ...
        try {
            ...
            //Convertemos os bytes para hexadecimal, assim podemos salvar no banco para posterior comparação se senhas
...
public static String convertStringToSHA(String valor) {
