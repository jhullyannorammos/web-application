<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="fornecedores"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>

<jsp:useBean id="fornecedorPersistence" class="br.com.application.persistence.jpa.FornecedorPersistence" />
<jsp:useBean id="f" class="br.com.application.domain.Fornecedor" />
		...
		<div class="row">
			...
			<div id="wrapper">
				...
				<table id="table-fornecedor" class="display">
					...
					<tbody>
						<fornecedores:forEach var="f" items="${fornecedorPersistence.findAll()}">
							<tr>
								<td>${f.fornecedor}</td>
								<td>${f.abrangencia}</td>
								<td> <span class="badge"> ${f.modelos.size()} modelo(s)</span></td>
								<td>(${f.telefone.DDD})${f.telefone.telefone}</td>
								<td>${f.endereco.cep}</td>
								<td>${f.endereco.cidade}-${f.endereco.uf}</td>
								<td>
