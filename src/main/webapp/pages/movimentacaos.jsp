<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="mov"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>

<jsp:useBean id="movimentacaoPersistence" class="br.com.application.persistence.jpa.MovimentacaoPersistence" />
<jsp:useBean id="movimentacao" class="br.com.application.domain.Movimentacao" />
		...
		<div class="row">
			...
			<div id="wrapper">
				...
				<table id="table-mov" class="display">
					...
					<tbody>
						<mov:forEach var="movimentacao" items="${movimentacaoPersistence.findAll()}">
							<tr>
								<td>${movimentacao.periodo}</td>
								<td>${movimentacao.movimentacao}</td>
								<td>${movimentacao.colaborador.matricula}</td>
								<td>${movimentacao.colaborador.departamento}</td>
								<td></td>
								<td>
