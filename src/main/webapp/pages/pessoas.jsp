<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="person"%>
...
<script type="text/javascript">
	...
	function update(idp){
		window.location = 'application.jsp?pg=183&&idp=' + idp;
	}
</script>
</head>
<body>
		...
		<div class="row">
			<div id="wrapper">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><i class="fa fa-edit"></i> <a href="?pg=181">Cadastrar</a></li>
				</ol>
				<table id="table-people" class="display">
					<thead>
						<tr>
							<th>Email</th>
							<th>Nome completo</th>
