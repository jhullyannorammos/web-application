...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="md"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>

<jsp:useBean id="produtoPersistence" class="br.com.application.persistence.jpa.ProdutoPersistence" />
<jsp:useBean id="produto" class="br.com.application.domain.Produto" />

<jsp:useBean id="modeloPersistence" class="br.com.application.persistence.jpa.ModeloPersistence" />
<jsp:useBean id="modelo" class="br.com.application.domain.Modelo" />
			...
			<div id="wrapper">
				...
				<form>
					...
					<div class="col-lg-3">
						...
						<md:forEach var="modelo" items="${modeloPersistence.findAll()}">
							<option value="${modelo.id}" >${modelo.fornecedor.fornecedor} ${modelo.modelo} ${modelo.lancamento}</option>
						</md:forEach>
						</select>
				...
				<table id="table-produto" class="display">
					...
					<tbody>
						<product:forEach var="p" items="${produtoPersistence.findAll()}">
							<tr>
								<td>${p.produto}</td>
								<td>${p.modelo.fornecedor.fornecedor}</td>
								<td>${p.modelo.modelo}</td>
								<td>${p.valor}</td>
								<td>
